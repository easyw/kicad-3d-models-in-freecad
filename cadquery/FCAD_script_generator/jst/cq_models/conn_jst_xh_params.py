...
def make_params_angled(num_pins, name):
    return Params(
        ...
        zdistance=6.1-5.75,
        file_name="JST_XH_S{num_pins:2d}B-XH-A-1_{num_pins:2d}x{pin_pitch:.2f}mm_Angled_compact".format(num_pins=num_pins, pin_pitch=pin_pitch)
    )
def make_params_angled_short(num_pins, name):
    return Params(
        ...
        body_length=2*2.45+(num_pins-1)*pin_pitch,
        zdistance=6.1-5.75,
        file_name="JST_XH_S{num_pins:2d}B-XH-A_{num_pins:2d}x{pin_pitch:.2f}mm_Angled".format(num_pins=num_pins, pin_pitch=pin_pitch)
    )
def make_params_straight(num_pins, name):
    return Params(
        ...
        body_length=2*2.45+(num_pins-1)*pin_pitch,
        zdistance=6.1-5.75,
        file_name="JST_XH_B{num_pins:2d}B-XH-A_{num_pins:2d}x{pin_pitch:.2f}mm_Straight".format(num_pins=num_pins, pin_pitch=pin_pitch)
    )

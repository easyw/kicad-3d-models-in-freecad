...
============================================
:Author:    Maurice, for model authors see cq_models files
...
+[freecad bin] main_generator.py series=6410+ +
+[freecad bin] main_generator.py series=6410 pins_filter=[2-4]+ +
+[freecad bin] main_generator.py+ +

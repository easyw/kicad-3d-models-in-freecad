...
## requirements ## +
link:https://github.com/jmwright/cadquery-freecad-module/archive/master.zip/[CadQuery module] version 0.30 +
...
examples in win: +
+c:\freecad\bin\freecad main_generator.py SOIC_8+ +
+c:\freecad\bin\freecad main_generator.py all+ +
in linux: +
+freecad ./main_generator.py SOIC_8+ +

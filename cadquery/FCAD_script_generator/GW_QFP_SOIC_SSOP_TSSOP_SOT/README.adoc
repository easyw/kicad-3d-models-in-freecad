...
examples in win: +
+c:\freecad\bin\freecad main_generator.py model_filter=SOIC-8_3.9x4.9mm_Pitch1.27mm+ +
+c:\freecad\bin\freecad main_generator.py series=soic+ +
+c:\freecad\bin\freecad main_generator.py series=soic disable_marker_color+ +
+c:\freecad\bin\freecad main_generator.py ?+ +
+c:\freecad\bin\freecad main_generator.py error_tolerant+ +
+c:\freecad\bin\freecad main_generator.py+ +

in linux: +
+freecad main_generator.py model_filter=SOIC-8_3.9x4.9mm_Pitch1.27mm+ +
+freecad main_generator.py series=soic+ +
+freecad main_generator.py series=soic disable_marker_color+ +
+freecad main_generator.py ?+ +
+freecad main_generator.py error_tolerant+ +
+freecad main_generator.py+ +

...
all_params_ssop = {
    'SSOP_20': Params(  # 5.6x7.2, pitch 0.65 20pin 2.0mm height
        ...
        ef=0.00,  # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'SSOP_24_Pad': Params(  # 5.6x7.2, pitch 0.65 20pin 2.0mm height
        ...
        npy=0,   # number of pins along y axis (length)
        epad=(5.0, 3.0),  # e Pad
        modelName='ssop_24_82x53_pad_p065',  # modelName
        rotation=0,  # rotation if required
        dest_dir_prefix='ssop',
        exclude=None,
        excludei=None
    ...
    'SSOP_24': Params(  # 5.6x7.2, pitch 0.65 20pin 2.0mm height
        ...
        npy=0,   # number of pins along y axis (length)
        epad=None,  # e Pad
        modelName='ssop_24_82x53_p065',  # modelName
        rotation=0,  # rotation if required
        dest_dir_prefix='ssop',
        exclude=None,
        excludei=None
    ...
    'SSOP_24_N': Params(  # 5.6x7.2, pitch 0.65 20pin 2.0mm height
        ...
        npy=0,   # number of pins along y axis (length)
        epad=None,  # e Pad
        modelName='ssop_24_N_39x86_p0635',  # modelName
        rotation=0,  # rotation if required
        dest_dir_prefix='ssop',
        exclude=None,
        excludei=None
    ...
    'SSOP_8': Params(  # 5.6x7.2, pitch 0.65 20pin 2.0mm height
        ...
        npy=0,   # number of pins along y axis (length)
        epad=None,  # e Pad
        modelName='ssop_8_35x44_p065',  # modelName
        rotation=0,  # rotation if required
        dest_dir_prefix='ssop',
        exclude=None,
        excludei=None
    ...
    'SSOP_14': Params(  # 5.6x7.2, pitch 0.65 20pin 2.0mm height
        ...
        npy=0,   # number of pins along y axis (length)
        epad=None,  # e Pad
        modelName='ssop_14_5x44_p065',  # modelName
        rotation=0,  # rotation if required
        dest_dir_prefix='ssop',
        exclude=None,
        excludei=None
    ...
    'SSOP_16': Params(  # 5.6x7.2, pitch 0.65 20pin 2.0mm height
        ...
        npy=0,   # number of pins along y axis (length)
        epad=None,  # e Pad
        modelName='ssop_16_59x53_p065',  # modelName
        rotation=0,  # rotation if required
        dest_dir_prefix='ssop',
        exclude=None,
        excludei=None
    ...
    'SSOP_16_N': Params(  # 5.6x7.2, pitch 0.65 20pin 2.0mm height
        ...
        npy=0,   # number of pins along y axis (length)
        epad=None,  # e Pad
        modelName='ssop_16_N_49x39_p0635',  # modelName
        rotation=0,  # rotation if required
        dest_dir_prefix='ssop',
        exclude=None,
        excludei=None
    ...
    'SSOP_28': Params(  # 5.6x7.2, pitch 0.65 20pin 2.0mm height
        ...
        npy=0,   # number of pins along y axis (length)
        epad=None,  # e Pad
        modelName='ssop_53x10_p065',  # modelName
        rotation=0,  # rotation if required
        dest_dir_prefix='ssop',
        exclude=None,
        excludei=None
    ...
    'SSOP_44': Params(  # 5.6x7.2, pitch 0.65 20pin 2.0mm height
        ...
        npy=0,   # number of pins along y axis (length)
        epad=None,  # e Pad
        modelName='ssop_44_178x103_p08',  # modelName
        rotation=0,  # rotation if required
        dest_dir_prefix='ssop',
        exclude=None,
        excludei=None
    ...
    'SSOP_48': Params(  # 5.6x7.2, pitch 0.65 20pin 2.0mm height
        ...
        npy=0,   # number of pins along y axis (length)
        epad=None,  # e Pad
        modelName='ssop_48_128x53_p05',  # modelName
        rotation=0,  # rotation if required
        dest_dir_prefix='ssop',
        exclude=None,
        excludei=None

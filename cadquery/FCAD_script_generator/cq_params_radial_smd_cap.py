...
all_params_radial_smd_cap = {# Aluminum SMD capacitors
    ...
    "A_D30_L54" : Params( # note L model height
        ...
        W         =0.55,     # pin width
        modelName = 'c_el_A_D30_L54', #modelName
        rotation  = -90, # rotation if required
        dest_dir_prefix = 'cap_El_smd'
    ),
    "H_D125_L135" : Params( # note L model height
        ...
        W         =0.9,     # pin width
        modelName = 'c_el_H_D125_L135', #modelName
        rotation  = -90, # rotation if required
        dest_dir_prefix = 'cap_El_smd'
    ),
    "J_D100_L135" : Params( # note L model height
        ...
        P         =4.6,     # distance between pins
        W         =0.9,     # pin width
        modelName = 'c_el_J_D100_L135', #modelName
        rotation  = -90, # rotation if required
        dest_dir_prefix = 'cap_El_smd'
    ),
    "K_D100_L165" : Params( # note L model height
        ...
        P         =4.6,     # distance between pins
        W         =0.9,     # pin width
        modelName = 'c_el_K_D100_L165', #modelName
        rotation  = -90, # rotation if required
        dest_dir_prefix = 'cap_El_smd'
    ),
    "L_D125_L165" : Params( # note L model height
        ...
        W         =0.9,     # pin width
        modelName = 'c_el_L_D125_L165', #modelName
        rotation  = -90, # rotation if required
        dest_dir_prefix = 'cap_El_smd'
    ),
    "P_D160_L165" : Params( # note L model height
        ...
        W         =1.2,     # pin width
        modelName = 'c_el_P_D160_L165', #modelName
        rotation  = -90, # rotation if required
        dest_dir_prefix = 'cap_El_smd'
    ),
    "R_D180_L165" : Params( # note L model height
        ...
        P         =6.7,     # distance between pins
        W         =1.2,     # pin width
        modelName = 'c_el_R_D180_L165', #modelName
        rotation  = -90, # rotation if required
        dest_dir_prefix = 'cap_El_smd'
    ),
    "S_D180_L215" : Params( # note L model height
        ...
        P         =6.7,     # distance between pins
        W         =1.2,     # pin width
        modelName = 'c_el_S_D180_L215', #modelName
        rotation  = -90, # rotation if required
        dest_dir_prefix = 'cap_El_smd'
    ),
    "U_D160_L215" : Params( # note L model height
        ...
        P         =6.7,     # distance between pins
        W         =1.2,     # pin width
        modelName = 'c_el_U_D160_L215', #modelName
        rotation  = -90, # rotation if required
        dest_dir_prefix = 'cap_El_smd'
    ),
}
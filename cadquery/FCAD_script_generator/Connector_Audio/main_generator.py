...
import cq_audio_jack_ledino  # modules parameters
from cq_audio_jack_ledino import *

import cq_audio_jack_neutrik  # modules parameters
from cq_audio_jack_neutrik import *

import cq_audio_jack_cui  # modules parameters
from cq_audio_jack_cui import *

import cq_audio_jack_qingpu  # modules parameters
from cq_audio_jack_qingpu import *


different_models = [
    cq_audio_jack_ledino(),
    cq_audio_jack_neutrik(),
    cq_audio_jack_cui(),
    cq_audio_jack_qingpu(),
]

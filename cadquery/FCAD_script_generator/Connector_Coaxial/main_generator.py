...
import cq_coaxial_amphenol  # modules parameters
from cq_coaxial_amphenol import *

import cq_coaxial_te  # modules parameters
from cq_coaxial_te import *

import cq_coaxial_molex  # modules parameters
from cq_coaxial_molex import *

import cq_coaxial_samtec  # modules parameters
...
def make_3D_model(models_dir, model_class, modelID):
    ...
    step_path=os.path.join(out_dir,modelName+'.step')

...
all_params = {
    ...
    'Converter_DCDC_MeanWell_NID60_THT': Params(   # ModelName
        ...
        A1 = 0.1,  # Package board separation
        rim = None, # No rim
        pin = (('round', 0.0, 0.0, 0.64, 4.5), ('round', 0.0, 2.54, 0.64, 4.5), ('round', 0.0, 5.08, 0.64, 4.5), ('round', 0.0, 7.62, 0.64, 4.5), ('round', 0.0, 10.16, 0.64, 4.5), ('round', 0.0, 35.56, 0.64, 4.5), ('round', 0.0, 38.1, 0.64, 4.5), ('round', 0.0, 40.64, 0.64, 4.5), ('round', 0.0, 43.18, 0.64, 4.5), ('round', 0.0, 45.72, 0.64, 4.5), ('round', 0.0, 48.26, 0.0, 0.64, 4.5)),  # Pin placement
    ...
    'Converter_DCDC_Murata_MGJ2DxxxxxxSC_THT': Params(   # ModelName
        ...
        pin = (('rect', 0.0, 0.0, 0.25, 3.00), ('rect', 0.0, 2.54, 0.25, 3.00), ('rect', 0.0, 10.16, 0.25, 3.00), ('rect', 0.0, 12.70, 0.25, 3.00), ('rect', 0.0, 15.24, 0.25, 3.00)),  # Pin placement

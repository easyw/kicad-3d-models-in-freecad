...
def generate_footprint_name(series_name, part_name, num_pins, pin_pitch):
    name = 'Molex_SlimStack_Receptacle_2x{:02d}_Pitch{:.1f}mm_{:s}-{:s}'.format(num_pins / 2, pin_pitch, series_name, part_name)
    return name

# e.g. "Molex_SlimStack_Receptacle_2x08_Pitch0.5mm_54722-0164"

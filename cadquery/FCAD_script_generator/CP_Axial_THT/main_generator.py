...
def make_axial_th(params):
    ...
    body = body.rotate((0,0,0), (0,1,0), 90).translate((-L/2,0,D/2))
    mmb = mmb.rotate((0,0,0), (0,1,0), 90).translate((-L/2,0,D/2))
    bar = bar.rotate((0,0,0), (0,1,0), 90).translate((-L/2,0,D/2))
    top = top.rotate((0,0,0), (0,1,0), 90).translate((-L/2,0,D/2))
...
if __name__ == "__main__" or __name__ == "main_generator":
    ...
    if len(sys.argv) < 3:
        ...
        model_to_build='CP_Axial_L10.0mm_D4.5mm_P15.00mm_Horizontal'
    else:
    ...
    for variant in variants:
        ...
        #body, base, mark, pins = make_axial_th(all_params[variant])
        body, base, mark, pins, top = make_axial_th(all_params[variant]) #body, base, mark, pins, top

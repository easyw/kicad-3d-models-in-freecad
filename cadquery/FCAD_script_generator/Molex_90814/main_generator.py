...
__title__ = "make 3D models of Molex Picoflex 90814 series connectors"
__author__ = "scripts: maurice and hyOzd; models: hackscribble"
__Comment__ = '''make 3D models of Molex Picoflex 90814 series connectors'''
...
import conn_molex_90814 as Picoflex_90814

series = [Picoflex_90814]
...
L.STR_int_licAuthor = "Stefan Olsson"
L.STR_int_licEmail = "stol@bredband.net"
...
if __name__ == "__main__" or __name__ == "main_generator":
    ...
    if len(sys.argv) < 3:
        FreeCAD.Console.PrintMessage('No variant name is given! building Molex_Picoflex_90814_04')
        model_to_build='Molex_Picoflex_90814_04'
    else:
        model_to_build=sys.argv[2]
		
    if model_to_build == "all":
        FreeCAD.Console.PrintMessage('All\r\n')
        modelfilter = "*"
    else:
        modelfilter = [model_to_build]

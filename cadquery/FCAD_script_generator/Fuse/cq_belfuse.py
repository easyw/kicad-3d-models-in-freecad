...
class cq_belfuse():
    ...
    def make_3D_model(self, modelID):
        ...
        FreeCAD.Console.PrintMessage('\r\n')
        FreeCAD.Console.PrintMessage('set_colors\r\n')
        self.set_colors(modelID)
        self.set_translate(modelID)
        FreeCAD.Console.PrintMessage('set_rotation\r\n')
...
#        case = case.translate(self.translate)
    ...
    def make_body(self, modelID):
        ...
        FreeCAD.Console.PrintMessage('make_body\r\n')
        #
        # Make body
        #
        ttdz = B - A
...
#        case = case.translate(self.translate)
    ...
    def make_pin(self, modelID):
        ...
        FreeCAD.Console.PrintMessage('make_pin\r\n')

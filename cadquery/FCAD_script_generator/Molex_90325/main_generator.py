...
__title__ = "make 3D models of Molex Picoflex 90325 series connectors"
__author__ = "scripts: maurice and hyOzd; models: hackscribble"
__Comment__ = '''make 3D models of Molex Picoflex 90325 series connectors'''
...
import conn_molex_90325 as Picoflex_90325

series = [Picoflex_90325]
...
if __name__ == "__main__" or __name__ == "main_generator":
    ...
    if len(sys.argv) < 3:
        FreeCAD.Console.PrintMessage('No variant name is given! building Molex_Picoflex_90325_04')
        model_to_build='Molex_Picoflex_90325_04'
    else:

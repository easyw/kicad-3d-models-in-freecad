...
#        K=0.2,          # Fillet radius for pin edges
    ...
    'DFN-14-2EP_3x4mm_Pitch0.5mm': Params( # from https://www.analog.com/media/en/package-pcb-resources/package/pkg_pdf/ltc-legacy-dfn/05081731_C_DE14MA.pdf
        c = 0.2,        # pin thickness, body center part height
#        K=0.2,          # Fillet radius for pin edges
        L = 0.4,        # pin top flat part length (including fillet radius)
        fp_s = True,     # True for circular pinmark, False for square pinmark (useful for diodes)
        ...
        npx = 7,  # number of pins along X axis (width)
        npy = 0,  # number of pins along y axis (length)
        epad = (1.07,1.65), # e Pad #epad = None, # e Pad
        excluded_pins = None, #no pin excluded
        modelName = 'DFN-14-2EP_3x4mm_Pitch0.5mm', #modelName
        rotation = -90, # rotation if required
        dest_dir_prefix = '../Housings_DFN_QFN.3dshapes/'
        ),

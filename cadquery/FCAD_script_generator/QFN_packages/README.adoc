...
examples in win: +
+c:\freecad\bin\freecad main_generator.py QFN-28-1EP_6x6mm_Pitch0.65mm+ +
+c:\freecad\bin\freecad main_generator.py allQFN+ +
+c:\freecad\bin\freecad main_generator.py allDiodes+ +
in linux: +
+freecad ./main_generator.py QFN-28-1EP_6x6mm_Pitch0.65mm+ +
+freecad ./main_generator.py allQFN+ +
+freecad ./main_generator.py allDiodes+ +

...
all_params = {
    ...
    'Keystone_2466_1xAAA': Params(   # ModelName
        ...
        pins = [('tht', 0.0, 0.0, 'round', 0.8, 0.8, 14.99), ('tht', 44.7, 0.0, 'round', 0.8, 0.8, 14.99)],      # Pins tht/smd, x pos, y pos, 'round/rect', diameter/x size, y size, length
        rotation = 0,                                   # Rotation if required
        body_color_key  = 'black body',                 # Body color
        pin_color_key   = 'metal grey pins',            # Pin color
        dest_dir_prefix = 'Battery.3dshapes'   # Destination directory
    ...
    'Keystone_2462_2xAA': Params(   # ModelName
        ...
        BM = [27.17, 8.965],            # Center of body
        npthpins = [('hole', 27.165, 0.0, 03.43), ('hole', 27.165, 14.99, 03.43)],  # 'type', x, y, circle diameter,))]
        pins = [('tht', 00.00, 00.00, 'round', 0.8, 0.8, 11.99), ('tht', 00.00, 14.99, 'round', 0.8, 0.8, 11.99)],      # Pins tht/smd, x pos, y pos, 'round/rect', diameter/x size, y size, length
        rotation = 0,                                   # Rotation if required
        body_color_key  = 'black body',                 # Body color
        pin_color_key   = 'metal grey pins',            # Pin color
        dest_dir_prefix = 'Battery.3dshapes'   # Destination directory
    ...
    'Keystone_2468_2xAAA': Params(   # ModelName
        ...
        pins = [('tht', 00.00, 00.00, 'round', 0.8, 0.8, 12.70), ('tht', 0.0, 12.70, 'round', 0.8, 0.8, 12.70)],      # Pins tht/smd, x pos, y pos, 'round/rect', diameter/x size, y size, length
        rotation = 0,                                   # Rotation if required
        body_color_key  = 'black body',                 # Body color
        pin_color_key   = 'metal grey pins',            # Pin color
        dest_dir_prefix = 'Battery.3dshapes'   # Destination directory
    ...
    'Keystone_2479_3xAAA': Params(   # ModelName
        ...
        BS = ['round'],                 # If the side should be 'round' or 'chamfer'
        BC = ['BC4', 'switchright'],    # Battery contact type, length
        BM = [23.715, 12.795],             # Center of body
    ...
    'MPD_BC2AAPC_2xAA': Params(   # ModelName
        ...
        pins = [('tht', 00.00, 00.00, 'round', 0.89, 0.89, 12.70), ('tht', 0.0, 13.60, 'round', 0.89, 0.89, 13.60)],      # Pins tht/smd, x pos, y pos, 'round/rect', diameter/x size, y size, length
        rotation = 0,                                   # Rotation if required
        body_color_key  = 'black body',                 # Body color
        pin_color_key   = 'metal grey pins',            # Pin color
        dest_dir_prefix = 'Battery.3dshapes'   # Destination directory
    ...
    'MPD_BC12AAPC_2xAA': Params(   # ModelName
        ...
        pins = [('tht', 0.0, 0.0, 'round', 0.9, 0.9, 11.20), ('tht', 102.00, 0.0, 'round', 0.9, 0.9, 11.20)],      # Pins tht/smd, x pos, y pos, 'round/rect', diameter/x size, y size, length
        rotation = 0,                                   # Rotation if required
        body_color_key  = 'black body',                 # Body color
        pin_color_key   = 'metal grey pins',            # Pin color
        dest_dir_prefix = 'Battery.3dshapes'   # Destination directory
    ...
    'Keystone_3034_1x20mm': Params(   # ModelName
        ...
        cellcnt = 1,                                # Number of battery
        L  = 21.21,                                 # Package length
        W  = 16.12,                                 # Package width
        H  = 04.06,                                 # Package height
        LC = [18.00, 04.85],                        # [back side width, distance back end to pad (W - distance to pad)]
        A1 = 0.1,                                   # package board seperation
        BC = ['BC6', -1.34],                        # Battery contact type, hole diameter in pad
        pins = [('smd', -11.25, 00.00, 'rect', 01.50, 05.08), ('smd', 11.25, 00.00, 'rect', 01.50, 05.08)],      # Pins tht/smd, x pos, y pos, 'round/rect', diameter/x size, y size, length
        rotation = 180,                             # Rotation if required
        body_color_key  = 'black body',             # Body color
        pin_color_key   = 'metal grey pins',        # Pin color
        dest_dir_prefix = 'Battery.3dshapes'        # Destination directory

...
from cq_cad_tools import getOutputDir, say, sayw, saye
...
destination_dir=getOutputDir("chip_caps")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 3:
        say('No variant name is given! building c_1206_h106')
